...
namespace DIO.Series
{
    class Program
    {
        ...
        {
			Console.WriteLine("Digite F para executar o serviço de Filmes e S para executar o serviço de Séries.");
			Console.WriteLine("Digite X para fechar o programa.");
		...
		private static void OpcaoSerie()
		{
			...
			while (opcaoSerie.ToUpper() != "X")
			{
				switch (opcaoSerie)
				{
					...
					TextoSerie();
					opcaoSerie = Console.ReadLine().ToUpper();
			}
		...
		private static void TextoSerie()
		{
			Console.WriteLine("--------------------------------------");
			Console.WriteLine();
		...
		private static void OpcaoFilme()
		{
			...
			while (opcaoFilme.ToUpper() != "X")
			{
				switch (opcaoFilme)
				{
					...
					TextoFilme();
					opcaoFilme = Console.ReadLine().ToUpper();
			}
		...
		private static void TextoFilme()
		{
			Console.WriteLine("--------------------------------------");
			Console.WriteLine();
